      ...
      <Form
        ...
        onFinish={onFinish}>
          <Form.Item
            name='adminname'
            rules={[
              {required: true, pattern: /[a-zA-Z-9_-]{4,16}$/, message: '请输入4-16位有效字符，包含字母，数字，下划线以及减号!',}
            ]}>
              <Input prefix={<UserOutlined className='site-form-item-icon' />} placeholder='管理员账号'></Input>
          </Form.Item>
          <Form.Item
            name='password'
            rules={[
